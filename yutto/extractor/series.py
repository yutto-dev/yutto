...
from yutto.processor.urlparser import regexp_collection, regexp_medialist, regexp_series
...
class SeriesExtractor(BatchExtractor):
    ...
    def match(self, url: str) -> bool:
        if (match_obj := regexp_medialist.match(url)) or (
            ...
            self.is_collection = True if regexp_collection.match(url) else False
            return True
        else:
            return False
