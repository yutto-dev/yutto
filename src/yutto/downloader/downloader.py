...
async def process_download(
    ...
    if not will_download_video:
        ...
        elif will_download_audio and audio["codec"] == "flac" and options["audio_save_codec"] == "copy":
            output_format = ".flac"
        elif will_download_audio and audio["codec"] == "eac3" and options["audio_save_codec"] == "copy":
