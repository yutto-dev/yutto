...
from yutto.utils.asynclib import CoroutineWrapper, first_successed_with_check
...
async def download_video_and_audio(
    ...
    if video is not None:
        ...
        vsize = await first_successed_with_check(
    ...
    if audio is not None:
        ...
        asize = await first_successed_with_check(
